...
namespace ActionCalculator.Models
{
    public static class StarPlayerRules
    {
        public static IReadOnlyList<StarPlayerRule> All { get; } = new StarPlayerRule[]
        {
            ...
            new(StarPlayer.GlartSmarshrip,              StarPlayerSkill.FrenziedRush,           ["Block", "Claws", "Grab", "Juggernaut", "Loner (4+)", "Stand Firm"],                                                                                                   "CL,L4"),
            ...
            new(StarPlayer.LordBorak,                   StarPlayerSkill.LordOfChaos,            ["Block", "Dirty Player", "Leader", "Loner (3+)", "Mighty Blow", "Put the Boot In", "Sneaky Git"],                                                                      "MB,L3,DP1,SG"),
            ...
            new(StarPlayer.PuggyBaconbreath,            StarPlayerSkill.HalflingLuck,           ["Block", "Dodge", "Loner (3+)", "Nerves Of Steel", "Right Stuff", "Stunty"],                                                                                           "D,L3"),
            new(StarPlayer.RashnackBackstabber,         StarPlayerSkill.ToxinConnoisseur,       ["Loner (4+)", "Shadowing", "Sidestep", "Sneaky Git", "Stab"],                                                                                                          "L4,SG"),
            new(StarPlayer.RipperBolgrot,               StarPlayerSkill.ThinkingMansTroll,      ["Bullseye", "Grab", "Loner (4+)", "Mighty Blow", "Regeneration", "Throw Team-mate"],                                                                                   "MB,L4"),
            ...
            new(StarPlayer.SkitterStabStab,             StarPlayerSkill.MasterAssassin,         ["Dodge", "Loner (4+)", "Prehensile Tail", "Shadowing", "Stab"],                                                                                                        "D,L4"),
