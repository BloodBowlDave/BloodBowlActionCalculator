...
namespace ActionCalculator.Strategies.Blocking
{
    public class RedDiceBlockStrategy : IActionStrategy
    {
        ...
        public RedDiceBlockStrategy(IActionMediator actionMediator, IRollOutcomeHelper rollOutcomeHelper)
        {
        ...
        {
            var rollOutcomes = _rollOutcomeHelper.GetRollOutcomesForRedDice(r, playerAction, usedSkills);
